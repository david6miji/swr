...
util.inherits(SwrPlaying,events.EventEmitter);

//  플레잉 인스턴트
SwrPlaying.prototype.Instants = {};

//  플레잉 객체를 생성한다. 
SwrPlaying.prototype.create = function create(record) {
	var self = this;
	
	console.log( 'CALL SwrPlaying.prototype.create()' );
	console.log( record );
	...
	instant.log 	= new SwrResult(record); 
...
// 플레잉 객체를 제거한다. 
SwrPlaying.prototype.destroy = function destroy(id) {

	var self = this;
	
	console.log( 'CALL SwrPlaying.prototype.destroy()' );
	console.log( id );
...
// 웹소켓 접근 허가 검사 
SwrPlaying.prototype.IsAllowed = function IsAllowed(request,id){
	
	console.log( 'CALL SwrPlaying.prototype.IsAllowed()' );
...
// 웹소켓 접속 처리를 한다. 
SwrPlaying.prototype.handlerWebSocket = function handlerWebSocket(request){
